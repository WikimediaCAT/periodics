...
#0	20	7	*	* /usr/bin/jsub -N genbd -once -quiet /data/project/jorobot/periodics/efemerides/genbd.sh
...
# toolforge-jobs run genbd --command "periodics/efemerides/genbd.sh" --image tf-python39 --schedule "0 20 7 * *"
