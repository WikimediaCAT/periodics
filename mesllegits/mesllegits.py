...
def main():
   ...
   for elt_article in llista:
      ...
      if titol!="Portada" and titol[0:9]!="Especial:" and titol[0:11]!="Viquipèdia:" and titol[0:8]!="Special:" and titol[0:7]!="Usuari:" and titol[0:8]!="Usuària:" and titol[0:12]!="Usuari Discu" and titol[0:12]!="Usuari_Discu" and titol[0:7]!="Fitxer:" and titol[0:9]!="À_Punt_FM" :
